...
public class CarControlCS : MonoBehaviour {
	...
	public Image leftPedal;
	public Image rightPedal;
	...
	void Start () {
		...
		gasPedal = GameObject.Find("GasPedal").GetComponent<Image>();
		brakePedal = GameObject.Find("BrakePedal").GetComponent<Image>();
		leftPedal = GameObject.Find("LeftPedal").GetComponent<Image>();
		rightPedal = GameObject.Find("RightPedal").GetComponent<Image>();
	...
	void DriveMobile()
	{
		...
		foreach (Touch touch in Input.touches) {
			...
			if (touch.phase == TouchPhase.Stationary /*&& gasPedal.transform(touch.position)*/)
			{
				throttleInput = 1;
			}
